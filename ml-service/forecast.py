...
def forecast_prices(
    ...
    # ---------------------------------------------------------
    # 1. Prepare the original historical data
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # 2. Create a daily working series
    #
    # The local dataset may have gaps. We forward-fill those
    # gaps only for constructing lag/rolling model features.
    # The original historical data itself is NOT changed.
    # ---------------------------------------------------------
    ...
    # ---------------------------------------------------------
    # 3. Put today's LIVE Mandi API price at today's date
    # ---------------------------------------------------------

    working_series.loc[live_date] = float(current_price)

    # ---------------------------------------------------------
    # 4. Forecast starts TOMORROW
    # ---------------------------------------------------------
